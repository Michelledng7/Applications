	...
	const [people, setPeople] = useState<IState['people']>([
		{
			...
			age: 32,
			notes:
				'The 22-time Grand Slam champion has always been appreciated for his ability to never give up',
		},
		{
			name: 'Roger Federer',
			...
			age: 40,
			notes:
				'Roger Federer holds several ATP records and is considered to be one of the greatest tennis players of all time.',
		},

		{
			...
			age: 29,
			notes:
				'Marcos Andres Giron (born July 24, 1993; Spanish: Marcos Girón) is an American professional tennis player.',
		},
	]);
	return (
		<div className='App'>
